...
export const EXTERNAL_SYSTEMS: ExternalSystem[] = [
  {
    ...
    url: env.VITE_EXT_FIREBERRY_URL ?? 'https://app.fireberry.com/app/login',
  ...
  },
  {
    ...
    url: env.VITE_EXT_PRIORITY_URL ?? 'https://priority1.ip-com.co.il/#',
  ...
  },
  {
    ...
    url:
      env.VITE_EXT_MECKANO_URL ?? 'https://app.meckano.co.il/login.php#login#',
  ...
  },
  {
    ...
    url: env.VITE_EXT_HADSHANUT_URL ?? 'https://app.ip-com.co.il',
    iconSrc: '/assets/ext-hadshanut.png',
    enabled: true,
  },
  {
    id: 'internal-app',
    label: 'iPracticom Workspace',
    title: 'iPracticom Workspace',
    url: env.VITE_EXT_INTERNAL_APP_URL ?? 'https://tools.ip-com.co.il/',
    iconSrc: null,
    enabled: true,
  },
  {
