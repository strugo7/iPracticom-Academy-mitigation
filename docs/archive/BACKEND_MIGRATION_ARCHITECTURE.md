> **⚠️ ארכיון (2026-07-09):** מסמך היסטורי. הצעת ה-stack כאן (PostgreSQL/Fastify)
> **נדחתה** — ההחלטה הסגורה: MySQL בענן החברה מאחורי REST API של צוות הפיתוח,
> אנחנו client בלבד. מקור אמת: `CLAUDE.md` §2 + `docs/36`-`37`. נשמר בזכות מיפוי
> 72 הפונקציות.
